...
import { readDraft, getStatus, renderedVisualOptions, carouselOptions } from "@/lib/drafts";
...
export default async function DraftPage({ params }: { params: Promise<{ date: string }> }) {
  ...
  const builtCarousels = carouselOptions(date);
